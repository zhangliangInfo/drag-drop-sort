...
function (_Component) {
  ...
  function DragDropSort(props) {
    ...
    _this.dragTag = _this.props.dragTag && _this.props.dragTag.toLowerCase(); // set the state.
  ...
  _createClass(DragDropSort, [{
    ...
    value: function BindEvent() {
      ...
      that._parent.addEventListener('dragleave', function (e) {
        e.preventDefault();
        var tar = that.FindParent(that._parent, e.target);

        var _tar = that.FindParent(that._parent, that.enterObj);
